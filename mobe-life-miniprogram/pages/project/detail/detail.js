      ...
      success: async (res) => {
        try {
          ...
          if (res.tapIndex === 0) {
            ...
            await reopenProjectWithNodes(projectId)
          } else {
            wx.hideLoading()
            return
          }
